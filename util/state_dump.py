...
def collect_state_dump(host_ip):
    ...
    results = {"api_endpoints": {}, "files": {}, "archive": "pending"}
    ...
    try:
        with paramiko.SSHClient() as ssh:
            ...
            ssh.connect(
                host_ip, username="root", password="", look_for_keys=False, allow_agent=False
            )
            ...
            total_steps = (
                len(endpoints) + len(all_remote_files) + 2
            )  # +1 for results.json, +1 for archive
